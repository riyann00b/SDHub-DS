...
> [!tip] **Is SQL a Programming Language?**
...
> [!tip] **SQL is Not Case-Sensitive (Mostly)**
...
2.  [MySQL 8.0 Reference Manual: Data Types](https://dev.mysql.com/doc/refman/8.0/en/data-types.html)
3.  [PostgreSQL Documentation: TRUNCATE](https://www.postgresql.org/docs/current/sql-truncate.html)
4.  [Microsoft SQL Docs: Case-Sensitivity](https://learn.microsoft.com/en-us/sql/relational-databases/collations/collation-and-unicode-support)